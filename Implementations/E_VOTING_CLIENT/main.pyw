...
def login_window():
    ...
    ttk.Label(form_frame, text='NISN (gunakan: "demo")').grid(column=1, row=2, sticky=EW, pady=6, padx=8)
    masukan_nisn.grid(column=1, row=3, sticky=EW, pady=6, padx=(8, 32))
    ttk.Label(form_frame, text='Token  (gunakan: "demo")').grid(column=1, row=4, sticky=EW, pady=6, padx=8)
